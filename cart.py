...
myDat2 = loadDataSet(r"D:\pythonPractice\test_data\cart\ex2.txt")
myMat2 = np.mat(myDat2)
myTree = createTree(myMat2,ops=(0,1))
myDatTest = loadDataSet(r"D:\pythonPractice\test_data\cart\ex2test.txt")
myMat2Test = np.mat(myDatTest)
# p(prune(myTree,myMat2Test))
...
myDat3 = loadDataSet(r"D:\pythonPractice\test_data\cart\exp2.txt")
myMat3 = np.mat(myDat3)

# p(createTree(myMat3,modelLeaf,modelErr,(1,10)))
...
trainMat = np.mat(loadDataSet(r"D:\pythonPractice\test_data\cart\bikeSpeedVsIq_train.txt"))
testMat = np.mat(loadDataSet(r"D:\pythonPractice\test_data\cart\bikeSpeedVsIq_test.txt"))

# 回归树
# myTree = createTree(trainMat,ops=(1,20))
# yHat = createForeCast(myTree,testMat[:,0])
# p(np.corrcoef(yHat,testMat[:,1],rowvar=0)[0,1])
